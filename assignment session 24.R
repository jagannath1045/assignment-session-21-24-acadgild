...
install.packages("Rtools")
setwd("C:/Users/Jagannath/Documents/assignment data acadgild/assignmnet 21-24")
loanTrain <- read.csv("C:/Users/Jagannath/Documents/assignment data acadgild/assignmnet 21-24/loan.csv", na.strings = c(""," ","NA"))
loanTrain<-loan{}
